// SELECT REGION
const selectRegion = document.querySelector('.header__region-select');
...
const forOpen = document.querySelector('.header__burger-menu-tablet');
burgerBtn.addEventListener('click', function (e) {
  e.preventDefault();
  if (burgerBtn.classList.contains('is-active')) {
    forOpen.style.cssText = 'display: none !important;';
  } else {
    forOpen.style.cssText = 'display: block !important;';
  }
...
tippy('.feedback__form-tooltip', {
  ...
  new JustValidate('.feedback-form', {
    ...
    messages: {
        ...
        tel: {
            required: 'Недопустимый формат телефона'
        },
            mail: 'Недопустимый формат e-mail'
      },
  })
  // validation
